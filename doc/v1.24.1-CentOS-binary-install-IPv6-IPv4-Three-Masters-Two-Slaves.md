# 二进制安装Kubernetes（k8s） v1.24.1 IPv4/IPv6双栈 （三主俩从）
...
```shell
ssh root@10.1.1.105 "nmcli con mod ens160 ipv4.addresses 10.0.0.81/8; nmcli con mod ens160 ipv4.gateway 10.0.0.1; nmcli con mod ens160 ipv4.method manual; nmcli con mod ens160 ipv4.dns "8.8.8.8"; nmcli con up ens160"
ssh root@10.1.1.106 "nmcli con mod ens160 ipv4.addresses 10.0.0.82/8; nmcli con mod ens160 ipv4.gateway 10.0.0.1; nmcli con mod ens160 ipv4.method manual; nmcli con mod ens160 ipv4.dns "8.8.8.8"; nmcli con up ens160"
ssh root@10.1.1.112 "nmcli con mod ens160 ipv4.addresses 10.0.0.83/8; nmcli con mod ens160 ipv4.gateway 10.0.0.1; nmcli con mod ens160 ipv4.method manual; nmcli con mod ens160 ipv4.dns "8.8.8.8"; nmcli con up ens160"
ssh root@10.1.1.113 "nmcli con mod ens160 ipv4.addresses 10.0.0.84/8; nmcli con mod ens160 ipv4.gateway 10.0.0.1; nmcli con mod ens160 ipv4.method manual; nmcli con mod ens160 ipv4.dns "8.8.8.8"; nmcli con up ens160"
ssh root@10.1.1.114 "nmcli con mod ens160 ipv4.addresses 10.0.0.85/8; nmcli con mod ens160 ipv4.gateway 10.0.0.1; nmcli con mod ens160 ipv4.method manual; nmcli con mod ens160 ipv4.dns "8.8.8.8"; nmcli con up ens160"
...
cfssl gencert \
   ...
   -hostname=127.0.0.1,k8s-master01,k8s-master02,k8s-master03,10.0.0.81,10.0.0.82,10.0.0.83,2408:8207:78ca:9fa1:181c::10,2408:8207:78ca:9fa1:181c::20,2408:8207:78ca:9fa1:181c::30 \
   -profile=kubernetes \
...
k8s-master01   NotReady   <none>   12s   v1.24.1
k8s-master02   NotReady   <none>   12s   v1.24.1
k8s-master03   NotReady   <none>   12s   v1.24.1
k8s-node01     NotReady   <none>   12s   v1.24.1
k8s-node02     NotReady   <none>   12s   v1.24.1
[root@k8s-master01 ~]#
...
[root@localhost yaml]# curl -I http://[2408:8207:78ca:9fa1:181c::10]:30779
HTTP/1.1 200 OK
Server: nginx/1.21.6
