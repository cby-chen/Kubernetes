...
安装包已经整理好：https://mirrors.chenby.cn/https://github.com/cby-chen/Kubernetes/releases/download/v1.33.0/kubernetes-v1.33.0.tar
...
cfssl_version='1.6.5'
kubernetes_server_version='1.33.0'
...
```shell
# https://github.com/containernetworking/plugins/releases/
# wget https://mirrors.chenby.cn/https://github.com/containernetworking/plugins/releases/download/v1.7.1/cni-plugins-linux-amd64-v1.7.1.tgz
...
# https://github.com/containerd/containerd/releases/
# wget https://mirrors.chenby.cn/https://github.com/containerd/containerd/releases/download/v2.0.5/containerd-2.0.5-linux-amd64.tar.gz
...
```shell
# https://github.com/kubernetes-sigs/cri-tools/releases/
# wget https://mirrors.chenby.cn/https://github.com/kubernetes-sigs/cri-tools/releases/download/v1.33.0/crictl-v1.33.0-linux-amd64.tar.gz
...
# https://github.com/kubernetes/kubernetes/tree/master/CHANGELOG
# 
# wget https://mirrors.chenby.cn/https://github.com/etcd-io/etcd/releases/download/v3.5.21/etcd-v3.5.21-linux-amd64.tar.gz
# wget https://cdn.dl.k8s.io/release/v1.33.0/kubernetes-server-linux-amd64.tar.gz
...
https://github.com/cby-chen/Kubernetes/releases/download/v1.33.0/kubernetes-v1.33.0.tar
```
...
```shell
# master01节点下载证书生成工具
# wget "https://mirrors.chenby.cn/https://github.com/cloudflare/cfssl/releases/download/v1.6.5/cfssl_1.6.5_linux_amd64" -O /usr/local/bin/cfssl
# wget "https://mirrors.chenby.cn/https://github.com/cloudflare/cfssl/releases/download/v1.6.5/cfssljson_1.6.5_linux_amd64" -O /usr/local/bin/cfssljson
...
+-------------------+------------------+---------+---------+-----------+------------+-----------+------------+--------------------+--------+
| 192.168.1.33:2379 |  8065f2e59c8d68c |  3.5.21 |   20 kB |      true |      false |         5 |         14 |                 14 |        |
| 192.168.1.32:2379 | b7b7ad6bf4db3f28 |  3.5.21 |   25 kB |     false |      false |         5 |         14 |                 14 |        |
| 192.168.1.31:2379 | bf047bcfe3b9bf27 |  3.5.21 |   20 kB |     false |      false |         5 |         14 |                 14 |        |
+-------------------+------------------+---------+---------+-----------+------------+-----------+------------+--------------------+--------+
...
k8s-master01   NotReady    <none>   16s   v1.33.0
k8s-master02   NotReady    <none>   13s   v1.33.0
k8s-master03   NotReady    <none>   12s   v1.33.0
k8s-node01     NotReady    <none>   10s   v1.33.0
k8s-node02     NotReady    <none>   9s    v1.33.0
[root@k8s-master01 ~]#
```
...
# 安装operator
kubectl create -f https://mirrors.chenby.cn/https://raw.githubusercontent.com/projectcalico/calico/v3.30.1/manifests/tigera-operator.yaml


# 下载配置文件
curl https://mirrors.chenby.cn/https://raw.githubusercontent.com/projectcalico/calico/v3.30.1/manifests/custom-resources.yaml -O
...
# 安装客户端
curl -L https://mirrors.chenby.cn/https://github.com/projectcalico/calico/releases/download/v3.29.3/calicoctl-linux-amd64 -o calicoctl
...
calico-apiserver   calico-apiserver-7bcdd9f77-b8gz9           1/1     Running   0               3m47s
calico-apiserver   calico-apiserver-7bcdd9f77-p6jq8           1/1     Running   0               3m47s
calico-system      calico-kube-controllers-69c6f48f98-bnvrn   1/1     Running   0               3m44s
calico-system      calico-node-66mft                          1/1     Running   2 (2m19s ago)   3m45s
calico-system      calico-node-c8mrl                          1/1     Running   0               3m45s
calico-system      calico-node-l8d6s                          1/1     Running   3 (2m25s ago)   3m45s
calico-system      calico-node-mvp4z                          1/1     Running   2 (2m24s ago)   3m45s
calico-system      calico-node-tf7kc                          1/1     Running   0               3m45s
calico-system      calico-typha-56fd654795-6qfbj              1/1     Running   0               3m41s
calico-system      calico-typha-56fd654795-gxhnk              1/1     Running   0               3m45s
calico-system      calico-typha-56fd654795-jrsjw              1/1     Running   0               3m41s
calico-system      csi-node-driver-b2dvk                      2/2     Running   0               3m44s
calico-system      csi-node-driver-cjtmk                      2/2     Running   0               3m44s
calico-system      csi-node-driver-j5b76                      2/2     Running   0               3m44s
calico-system      csi-node-driver-lpx2d                      2/2     Running   0               3m44s
calico-system      csi-node-driver-p8vvx                      2/2     Running   0               3m44s
calico-system      goldmane-86cd9d999d-f7dj5                  1/1     Running   0               3m45s
calico-system      whisker-59f496cc54-zdhlm                   2/2     Running   0               116s
tigera-operator    tigera-operator-68f7c7984d-4lhs9           1/1     Running   2 (2m33s ago)   4m23s
...
k8s-master01   92m          1%       1761Mi          49%         
k8s-master02   80m          1%       1820Mi          51%         
k8s-master03   120m         1%       1636Mi          46%         
k8s-node01     96m          1%       1107Mi          31%         
k8s-node02     47m          0%       1048Mi          29%  
```
...
NAME                              TYPE       CLUSTER-IP     EXTERNAL-IP   PORT(S)         AGE
kubernetes-dashboard-kong-proxy   NodePort   10.96.57.143   <none>        443:32725/TCP   25s
[root@k8s-master01 ~]# 
```
...
eyJhbGciOiJSUzI1NiIsImtpZCI6IkVkajVhS0JDTnBxQkhzT2w2Yy1ZN0hIc2Q5WmlvS21WdVB1RXpOSDNwUWMifQ..n-_m8mXJOXsL_4b23A2LVoNGMNPFIDI7NVogy__yholJBfEDG33Yy1J3DI7iPiwiBDDU2sHpbgyXFNRKK99Ew3BjitW5T8Qv8NMCbtiaSltSPW_4q_ZATFv7yNUKlFqczHzUDVAE6RM4I7hj8htcW4wnHW-oubpLh-4NDPsSblvL5zfQbKc60H7y6XJEwYG7OShtnLYxbPxbT92txPNJfJ86T7ttrGMIVTnKiJNqS3UPCl6ikxa7w62KqZaDO2ITej0ajle_dLu22ntsdN_Lo2FoobVK5cM7VSptcKRkB3GV73-cTBoKCkHzSm5pOYnSpHSnHXoBoj_iXgDIgo0Ekw
```
...
eyJhbGciOiJSUzI1NiIsImtpZCI6IkVkajVhS0JDTnBxQkhzT2w2Yy1ZN0hIc2Q5WmlvS21WdVB1RXpOSDNwUWMifQ..PwFyG5EfYBW890xoFGVv5wR5GHFMmkl_rZErgAWimW2fLxzoohabWzXhrKUMLd-C3osqKybQyGFtTNoJA9ZzTGz1KAIJeR-4irxvHIX923JZ5Y1r6IS2hYJzKR-ITIRCXLGxrLeSnEtzLf6ahslmtOQPV6MZteR8mbyxwHu_MCV-bjz_KANs3Wc5wVtRbbfGFPUxHR_6CQC7pX3tsOKi23O3FPh52ZltJns5mULlU-Rb4kDErShp8uhzU9xFxOVFZj7OW0eWHlIZKg--JqL8CLJEAowDaqNxtO1cAySvymb_WBwtC7oSdMlDRyIggqJmqDvr72gkRETJ181NsasXiA
```

## 13.5登录dashboard

https://192.168.1.31:32725/
...
```shell
# 下载应用包
wget https://mirrors.chenby.cn/https://github.com/metallb/metallb/archive/refs/tags/v0.15.2.tar.gz
tar -xvf v0.15.2.tar.gz
cd metallb-0.15.2/config/manifests
...
NAME                                            READY   STATUS    RESTARTS   AGE
pod/ingress-nginx-controller-578c564c54-frrg2   1/1     Running   0          84s

NAME                                         TYPE           CLUSTER-IP      EXTERNAL-IP    PORT(S)                      AGE
service/ingress-nginx-controller             LoadBalancer   10.110.195.4    192.168.1.73   80:31035/TCP,443:31363/TCP   85s
service/ingress-nginx-controller-admission   ClusterIP      10.111.69.160   <none>         443/TCP                      85s

NAME                                       READY   UP-TO-DATE   AVAILABLE   AGE
deployment.apps/ingress-nginx-controller   1/1     1            1           85s

NAME                                                  DESIRED   CURRENT   READY   AGE
replicaset.apps/ingress-nginx-controller-578c564c54   1         1         1       85s
[root@k8s-master01 ~]# 
```
## 15.2创建测试应用
...
NAME           TYPE        CLUSTER-IP            EXTERNAL-IP   PORT(S)        AGE
chenby         NodePort    fd00:1111::361a       <none>        80:31499/TCP   5s
[root@k8s-master01 ~]# 

# 直接访问POD地址
[root@k8s-master01 ~]# curl -I http://[fd00:1111::d38c]
HTTP/1.1 200 OK
Server: nginx/1.27.3
...
# 使用IPv4地址访问测试
[root@k8s-master01 ~]# curl -I http://192.168.1.31:31499
HTTP/1.1 200 OK
Server: nginx/1.21.6
...
# 使用主机的内网IPv6地址测试
[root@k8s-master01 ~]# curl -I http://[fc00::31]:31499
HTTP/1.1 200 OK
Server: nginx/1.21.6
...
# 使用主机的公网IPv6地址测试
[root@k8s-master01 ~]# curl -I http://[2408:822a:732:a6c1::44e]:31499
HTTP/1.1 200 OK
Server: nginx/1.27.3
...
# 查看安装情况
[root@k8s-master01 ~]#  kubectl get all -n kubesphere-system
NAME                                         READY   STATUS    RESTARTS   AGE
pod/extensions-museum-749bf6969b-mnlkp       1/1     Running   0          15m
pod/ks-apiserver-9b5b54fc6-pthgt             1/1     Running   0          15m
pod/ks-console-54bfd98c76-8ffqh              1/1     Running   0          14m
pod/ks-controller-manager-85b654546c-2c9kg   1/1     Running   0          15m

NAME                            TYPE        CLUSTER-IP       EXTERNAL-IP   PORT(S)        AGE
service/extensions-museum       ClusterIP   10.101.133.202   <none>        443/TCP        15m
service/ks-apiserver            ClusterIP   10.107.171.191   <none>        80/TCP         15m
service/ks-console              NodePort    10.100.17.0      <none>        80:30880/TCP   15m
service/ks-controller-manager   ClusterIP   10.103.105.147   <none>        443/TCP        15m

NAME                                    READY   UP-TO-DATE   AVAILABLE   AGE
deployment.apps/extensions-museum       1/1     1            1           15m
deployment.apps/ks-apiserver            1/1     1            1           15m
deployment.apps/ks-console              1/1     1            1           15m
deployment.apps/ks-controller-manager   1/1     1            1           15m

NAME                                               DESIRED   CURRENT   READY   AGE
replicaset.apps/extensions-museum-749bf6969b       1         1         1       15m
replicaset.apps/ks-apiserver-9b5b54fc6             1         1         1       15m
replicaset.apps/ks-console-54bfd98c76              1         1         1       14m
replicaset.apps/ks-console-674f76b9cc              0         0         0       15m
replicaset.apps/ks-controller-manager-85b654546c   1         1         1       15m
[root@k8s-master01 ~]# 
```
