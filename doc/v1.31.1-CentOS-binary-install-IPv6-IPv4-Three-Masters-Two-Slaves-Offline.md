...
cri_containerd_cni_version='1.7.22'
crictl_version='v1.31.1'
cri_dockerd_version='0.3.15'
etcd_version='v3.5.16'
cfssl_version='1.6.5'
kubernetes_server_version='1.31.1'
...
https://github.com/cby-chen/Kubernetes/releases/download/v1.31.1/kubernetes-v1.31.1.tar
```
...
-config=ca-config.json   \
-hostname=10.96.0.1,192.168.1.36,127.0.0.1,kubernetes,kubernetes.default,kubernetes.default.svc,kubernetes.default.svc.cluster,kubernetes.default.svc.cluster.local,x.oiox.cn,z.oiox.cn,192.168.1.31,192.168.1.32,192.168.1.33,192.168.1.34,192.168.1.35,192.168.1.36,192.168.1.37,192.168.1.38,192.168.1.39,192.168.1.50,::1   \
...
+-------------------+------------------+---------+---------+-----------+------------+-----------+------------+--------------------+--------+
| 192.168.1.33:2379 | 29ba1a59fc9631ce |  3.5.13 |   20 kB |     false |      false |         3 |         13 |                 13 |        |
| 192.168.1.32:2379 | 987ed990c5d78aa4 |  3.5.13 |   33 kB |     false |      false |         3 |         13 |                 13 |        |
| 192.168.1.31:2379 | 3f3d8e1e5a05c016 |  3.5.13 |   20 kB |      true |      false |         3 |         13 |                 13 |        |
+-------------------+------------------+---------+---------+-----------+------------+-----------+------------+--------------------+--------+
...
ExecStart=/usr/local/bin/kubelet \\
    ...
    --container-runtime-endpoint=unix:///run/cri-dockerd.sock  \\
    --node-labels=node.kubernetes.io/node=   \\
    --node-ip=192.168.1.31,2408:822a:734:2cd1::a74
[Install]
WantedBy=multi-user.target
EOF
```
...
k8s-master01   Ready    <none>   16s   v1.31.1
k8s-master02   Ready    <none>   13s   v1.31.1
k8s-master03   Ready    <none>   12s   v1.31.1
k8s-node01     Ready    <none>   10s   v1.31.1
k8s-node02     Ready    <none>   9s    v1.31.1
[root@k8s-master01 ~]#
```
...
spec:
  containers:
  - name: busybox
    image: jockerhub.com/library/busybox:1.28
    command:
      - sleep
      - "3600"
...
eyJhbGciOiJSUzI1NiIsImtpZCI6IktSUlBJaTVOTzBfSkdaWW5uVkprYmJSRE5ZeVRhR2wwTGFzZlEtOVpuanMifQ..Oh-VN3fOkcrgAi3Clbt5Z4C-R_1wWwnQmyE7aeNczJ7Cda5gWoZLSLVfrow3qUAHQMoRMsL7QaYXUV-Ppg5j-tqiPw-oym25pWEYfMPUnWQZBhZNGFS68uDylzsKDkXrX7N-y8BxMl6f5YUCXaou9NLoOpugv-T2lzsGCWcXZjLbPoLC38C8EoLMMix1US3jC7PgwMUVo3RJ9ZbKGUaCl7DBo4CRPFNfZzfo0M-PxwQfklWrkqXIwJ3qzq4CwCfowCP-wiISAiB_XHgV6fYgjdzS-4kh0rPVgMbTqNq4AMtQ_ocDhC5bDP_2WIOuLJ7hlyTYiHEzRtmScQcJ4Sjmsg
```
...
eyJhbGciOiJSUzI1NiIsImtpZCI6IktSUlBJaTVOTzBfSkdaWW5uVkprYmJSRE5ZeVRhR2wwTGFzZlEtOVpuanMifQ..S9OFd1_6Ps3dGm7l_SmnUfDhsN7Rc4AgvJvsUiw7k5YuhJFF8m4jpvJOyy3d7sxM__rVV77SstWL2Cc2vP6Rp3CwKV6_RJBdXj_U5M7XiPUdfsRClx99XMV7hMFaK0odOIBPmS8ILNNE2JjmcAssfFTj3-nfnkeK1nFXi8dhfkxmJkE7x5lSZ7OLKm88KAaTKlSe6SOKcuC2qBmnboO23k-9jhNppvB9Ngojkby8zJ94L7RfyOut13f6KlNjn6-sPPfe0QaTcIuu9HzpSnu-EoQ_6T8LjPU32T8GNlT8y-9husvqaJ7MztdYSP4bd6dSaZQmYtXSO-QRswZNogN1hg
```
...
# 修改为国内源 docker源可选
sed -i "s#registry.k8s.io/ingress-nginx/#registry.aliyuncs.com/chenby/#g" deploy.yaml
...
[root@localhost yaml]# curl -I http://192.168.1.31:30495
HTTP/1.1 200 OK
Server: nginx/1.21.6
