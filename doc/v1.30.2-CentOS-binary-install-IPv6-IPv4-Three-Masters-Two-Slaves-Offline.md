...
ll /usr/local/bin/
总用量 749608
-rwxr-xr-x. 1 root root    39031240  6月  5 10:30 containerd
-rwxr-xr-x. 1 root root     7176192  6月  5 10:30 containerd-shim
-rwxr-xr-x. 1 root root     8884224  6月  5 10:30 containerd-shim-runc-v1
-rwxr-xr-x. 1 root root    12169216  6月  5 10:30 containerd-shim-runc-v2
-rwxr-xr-x. 1 root root    17723392  6月  5 10:30 containerd-stress
-rwxr-xr-x. 1 root root    53348190  6月  5 10:31 crictl
-rwxr-xr-x. 1 root root    55515383  6月  5 10:31 critest
-rwxr-xr-x. 1 root root    26329344  6月  5 10:31 ctd-decoder
-rwxr-xr-x. 1 root root    18870272  6月  5 10:30 ctr
-rwxr-xr-x. 1 1000 docker  23146496  3月 30 02:28 etcd
-rwxr-xr-x. 1 1000 docker  17534976  3月 30 02:28 etcdctl
-rwxr-xr-x. 1 root root   112877720  6月 12 04:42 kube-apiserver
-rwxr-xr-x. 1 root root   107462808  6月 12 04:42 kube-controller-manager
-rwxr-xr-x. 1 root root    51454104  6月 12 04:42 kubectl
-rwxr-xr-x. 1 root root   100124920  6月 12 04:42 kubelet
-rwxr-xr-x. 1 root root    57598104  6月 12 04:42 kube-proxy
-rwxr-xr-x. 1 root root    58319000  6月 12 04:42 kube-scheduler
...
https://github.com/cby-chen/Kubernetes/releases/download/v1.30.2/kubernetes-v1.30.2.tar
```
...
cfssl gencert \
   ...
   -hostname=127.0.0.1,k8s-master01,k8s-master02,k8s-master03,192.168.1.41,192.168.1.42,192.168.1.43,::1 \
   -profile=kubernetes \
...
-config=ca-config.json   \
-hostname=10.96.0.1,192.168.1.46,127.0.0.1,kubernetes,kubernetes.default,kubernetes.default.svc,kubernetes.default.svc.cluster,kubernetes.default.svc.cluster.local,x.oiox.cn,z.oiox.cn,192.168.1.41,192.168.1.42,192.168.1.43,192.168.1.44,192.168.1.45,192.168.1.46,192.168.0.47,192.168.0.48,192.168.0.49,192.168.1.50,::1   \
...
+-------------------+------------------+---------+---------+-----------+------------+-----------+------------+--------------------+--------+
| 192.168.1.43:2379 | 29ba1a59fc9631ce |  3.5.13 |   20 kB |     false |      false |         3 |         13 |                 13 |        |
| 192.168.1.42:2379 | 987ed990c5d78aa4 |  3.5.13 |   33 kB |     false |      false |         3 |         13 |                 13 |        |
| 192.168.1.41:2379 | 3f3d8e1e5a05c016 |  3.5.13 |   20 kB |      true |      false |         3 |         13 |                 13 |        |
+-------------------+------------------+---------+---------+-----------+------------+-----------+------------+--------------------+--------+
...
ExecStart=/usr/local/bin/kubelet \\
    ...
    --container-runtime-endpoint=unix:///run/cri-dockerd.sock  \\
    --node-labels=node.kubernetes.io/node=   \\
    --node-ip=192.168.1.41,2408:822a:736:82b1::da3
[Install]
WantedBy=multi-user.target
EOF
```
...
k8s-master01   Ready    <none>   16s   v1.30.2
k8s-master02   Ready    <none>   13s   v1.30.2
k8s-master03   Ready    <none>   12s   v1.30.2
k8s-node01     Ready    <none>   10s   v1.30.2
k8s-node02     Ready    <none>   9s    v1.30.2
[root@k8s-master01 ~]#
```
...
[root@k8s-master01 yaml]# sed -i "s#docker.io/#docker.chenby.cn/#g" monitoring-example.yaml
...
spec:
  containers:
  - name: busybox
    image: docker.chenby.cn/library/busybox:1.28
    command:
      - sleep
      - "3600"
...
sed -i "s#docker.io/#docker.chenby.cn/#g" values.yaml
...
eyJhbGciOiJSUzI1NiIsImtpZCI6Ii1tR254WmV2dndiM2luelpxaENjNXlHZGQ2SkZReVRRaDB3SFhJX2t1dWsifQ..FHqYZG-mp1DmgpuEDDHOw1sKHD5Sl3N6ZgMIg64JPmkLONYf4Sz6aF6kJJDXMA_TV4itsl9ewNS9cOzLJELTEvgQ7hncNe6pFz5eszo35jWaAyuqwSwO0o0QSwxB5FMb_eYL3Xb9Kt7mvUoJjW8si4-AsrXCEvoGH6EXh3Yc0nP4oyc8V61jHvhOw7ee0RQn9yewKAzrS2Pto9u_q2OWHIpw5h0E-lSYXZzgtlECA-y648BcRUGX8w5t4Eg9ActHOCyJ6SScF9mQixHZPUCt6BKSlv-UmReYKmZfqoGVrhsDrLt12yFsapekv4oVDH17wUCCdqcTVIAaT7h4ejSlFw
```
...
eyJhbGciOiJSUzI1NiIsImtpZCI6Ii1tR254WmV2dndiM2luelpxaENjNXlHZGQ2SkZReVRRaDB3SFhJX2t1dWsifQ..CJAooKa-SLqxtLb1sLYMYdu6Dq1m7--cEWXxDMyutOmvhmBILg4ZJmHe61eudNN3p5QN0Yrl20TrdkoRITNCD_ApRIEFfZuTG4_hl529GuvACKbl-4PvXHV9i749jHn1ZGH9wRtZlJoILe7d5Y9JWLs70k8BfYuEFgX79Ene2ZpPG1aVi4sFfS1UFXX4ioZsIR6Tu84Mjd7uy2lKYOPgjuuELQdmb9kdvBePHxaKv5jnYdgfOX7RqC3wb_yT82Qv_yMU8rAfUX8uuMF5yUDtt7fRsbySSiH2SXHNGYUS5v__996BRLfN7W1_1056qWdJ5ySY4a6NdghRXSLr35fIXw
```
